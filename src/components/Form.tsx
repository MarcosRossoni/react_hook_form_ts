import {userForms} from "../hooks/userForms.tsx";
...
const Form = () => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="w-96 bg-white p-4 rounded-md ">
            ...
            <div className="flex flex-col gap-2 mb-2">
                <label htmlFor="gender">Nome:</label>
            ...
            <div className="flex flex-col gap-2 mb-2">
                <div className="flex gap-2">
                    <input type="checkbox" id="confirmpassword"
                           placeholder="Concordo com os termos" {...register("agree")}/>
